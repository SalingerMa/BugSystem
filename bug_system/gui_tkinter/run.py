...
table1.grid(column=0, row=1, sticky='W', padx=4, pady=8, columnspan=3)
table2.grid(column=0, row=3, sticky='W', padx=4, pady=8, columnspan=3)
table3.grid(column=0, row=5, sticky='W', padx=4, pady=8, columnspan=3)
